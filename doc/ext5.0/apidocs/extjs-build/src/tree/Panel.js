...
Ext.define('Ext.tree.Panel', {
     ...
     * @param {String}          path The path to brin into view. The path may be absolute, including a leading separator and starting
    ...
    ensureVisible: function(path, options) {
        ...
        if (path.isEntity) {
            return this.callParent([path, field, separator, callback, scope]);
        }
        ...
        var me = this,
            ...
            node,
            parentNode,
            onLastExpanded = function(success, lastExpanded, targetNode) {
                ...
                if (targetNode) {
                    me.self.superclass.ensureVisible.call(me, targetNode, options);
                } else {
