...
Ext.define('Ext.grid.ColumnLayout', {
    ...
    beginLayout: function (ownerContext) {
        ...
        if (owner.isRootHeader && !grid.isLocked) {
            // In a locking grid, the scrollbar is only managed on the normal side. The
            // "isLocked" flag will be undefined when not locking, so it works as a falsey
            // value here.
    ...
    determineScrollbarWidth: function (ownerContext) {
        var me = this,
            ...
            manageScrollbar = !reserveScrollbar && grid.view.scrollFlags.y;
    ...
    calculate: function (ownerContext) {
        var me = this,
            ...
            lockingPartnerContext, ownerGrid, view,
        ...
        if (grid && state.parallelDone) {
            ...
            if (me.viewScrollX === undefined && view.scrollFlags.x) {
    ...
    publishInnerCtSize: function(ownerContext) {
        ...
        if (cw != null && owner.isRootHeader) {
            size.width = cw + ownerContext.state.scrollbarAdjustment;
        }
