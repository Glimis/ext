...
Ext.define('Ext.util.Focusable', {
    ...
    /**
     * Clear the focus listeners applied by addFocusListener.
     * @private
     */
    clearFocusListeners: function() {
        var me = this,
            focusListeners = me.focusListeners;

        if (focusListeners) {
            focusListeners.destroy();
        }
        me.focusListeners = null;
        me.focusListenerAdded = false;
    },
